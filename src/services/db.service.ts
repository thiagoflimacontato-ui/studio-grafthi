...
export class DbService {
  ...
  async fetchSettings() {
    ...
    if (!error && data) {
      const mapped: SiteSettings = {
        ...
        bannerTextColor: data.banner_text_color || '#ffffff',
        bannerBackgroundColor: data.banner_background_color || '#0f172a',
        bannerAlignment: data.banner_alignment || 'left',
        bannerButtonText: data.banner_button_text || 'Ver Produtos',
        bannerButtonLink: data.banner_button_link || '/catalogo',
        bannerButtonStyle: data.banner_button_style || 'primary',
        bannerOverlayActive: data.banner_overlay_active ?? true,
        bannerOverlayColor: data.banner_overlay_color || '#000000',
        bannerOverlayOpacity: data.banner_overlay_opacity || 0.3,
  ...
  async updateSettings(newSettings: SiteSettings) {
    const dbPayload = {
      ...
      banner_text_color: newSettings.bannerTextColor,
      banner_background_color: newSettings.bannerBackgroundColor,
      banner_alignment: newSettings.bannerAlignment,
      banner_button_text: newSettings.bannerButtonText,
      banner_button_link: newSettings.bannerButtonLink,
      banner_button_style: newSettings.bannerButtonStyle,
      banner_overlay_active: newSettings.bannerOverlayActive,
      banner_overlay_color: newSettings.bannerOverlayColor,
      banner_overlay_opacity: newSettings.bannerOverlayOpacity,
